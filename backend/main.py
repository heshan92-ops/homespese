...
from routers import movements, budgets, dashboard, auth, users, categories, config, recurring, families, search, goals
...
app.include_router(goals.router)   # NEW: Savings Goals
